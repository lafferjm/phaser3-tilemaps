class MouseTileMarker {
    ...
    update() {
        ...
        const snappedWorldPointer = this.map.tileToWorldXY(pointerTileXY.x, pointerTileXY.y);
        this.graphics.setPosition(snappedWorldPointer.x, snappedWorldPointer.y);
    }
...
export default MouseTileMarker;
